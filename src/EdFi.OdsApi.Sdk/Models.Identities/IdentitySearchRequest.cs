...
namespace EdFi.OdsApi.Sdk.Models.Identities
{
    /// <summary>
    /// IdentitySearchRequest
    /// </summary>
    [DataContract]
    public partial class IdentitySearchRequest :  IEquatable<IdentitySearchRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentitySearchRequest" /> class.
        /// </summary>
        ...
        public IdentitySearchRequest(DateTime? birthDate = default(DateTime?), Location birthLocation = default(Location), int? birthOrder = default(int?), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string sexType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentitySearchRequest {\n");
        ...
        {
            return this.Equals(input as IdentitySearchRequest);
        }

        /// <summary>
        /// Returns true if IdentitySearchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentitySearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentitySearchRequest input)
        {
            if (input == null)
                return false;
