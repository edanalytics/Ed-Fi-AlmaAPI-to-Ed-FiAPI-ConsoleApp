...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateAddressPeriod :  IEquatable<TpdmCandidateAddressPeriod>
    {
        /// <summary>
        ...
        public TpdmCandidateAddressPeriod(DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?))
        {
            ...
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for TpdmCandidateAddressPeriod and cannot be null");
            }
            else
            {
