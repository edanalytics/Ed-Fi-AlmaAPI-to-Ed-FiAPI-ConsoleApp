...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEvaluationObjectiveReference :  IEquatable<TpdmEvaluationObjectiveReference>
    {
        /// <summary>
        ...
        public TpdmEvaluationObjectiveReference(int? educationOrganizationId = default(int?), string evaluationObjectiveTitle = default(string), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int? schoolYear = default(int?), string termDescriptor = default(string), Link link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("educationOrganizationId is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("evaluationObjectiveTitle is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("evaluationPeriodDescriptor is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("evaluationTitle is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceEvaluationTitle is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            if (schoolYear == null)
            {
                throw new InvalidDataException("schoolYear is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("termDescriptor is a required property for TpdmEvaluationObjectiveReference and cannot be null");
            }
            else
            {
