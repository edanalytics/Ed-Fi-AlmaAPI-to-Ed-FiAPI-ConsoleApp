...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStaffAddress :  IEquatable<EdFiStaffAddress>
    {
        /// <summary>
        ...
        public EdFiStaffAddress(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string localeDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool? doNotPublishIndicator = default(bool?), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), List<EdFiStaffAddressPeriod> periods = default(List<EdFiStaffAddressPeriod>))
        {
            ...
            {
                throw new InvalidDataException("addressTypeDescriptor is a required property for EdFiStaffAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("stateAbbreviationDescriptor is a required property for EdFiStaffAddress and cannot be null");
            }
            else
            {
            ...
            if (city == null)
            {
                throw new InvalidDataException("city is a required property for EdFiStaffAddress and cannot be null");
            }
            else
            {
                this.City = city;
            ...
            if (postalCode == null)
            {
                throw new InvalidDataException("postalCode is a required property for EdFiStaffAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("streetNumberName is a required property for EdFiStaffAddress and cannot be null");
            }
            else
            {
