...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateElectronicMail :  IEquatable<TpdmCandidateElectronicMail>
    {
        /// <summary>
        ...
        public TpdmCandidateElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool? doNotPublishIndicator = default(bool?), bool? primaryEmailAddressIndicator = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("electronicMailTypeDescriptor is a required property for TpdmCandidateElectronicMail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("electronicMailAddress is a required property for TpdmCandidateElectronicMail and cannot be null");
            }
            else
            {
