...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmSurveyResponsePersonTargetAssociation :  IEquatable<TpdmSurveyResponsePersonTargetAssociation>
    {
        /// <summary>
        ...
        public TpdmSurveyResponsePersonTargetAssociation(string id = default(string), EdFiPersonReference personReference = default(EdFiPersonReference), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), string etag = default(string))
        {
            ...
            {
                throw new InvalidDataException("personReference is a required property for TpdmSurveyResponsePersonTargetAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("surveyResponseReference is a required property for TpdmSurveyResponsePersonTargetAssociation and cannot be null");
            }
            else
            {
