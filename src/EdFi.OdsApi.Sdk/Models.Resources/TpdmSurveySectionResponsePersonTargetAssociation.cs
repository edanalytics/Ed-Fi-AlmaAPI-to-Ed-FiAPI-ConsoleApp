...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmSurveySectionResponsePersonTargetAssociation :  IEquatable<TpdmSurveySectionResponsePersonTargetAssociation>
    {
        /// <summary>
        ...
        public TpdmSurveySectionResponsePersonTargetAssociation(string id = default(string), EdFiPersonReference personReference = default(EdFiPersonReference), EdFiSurveySectionResponseReference surveySectionResponseReference = default(EdFiSurveySectionResponseReference), string etag = default(string))
        {
            ...
            {
                throw new InvalidDataException("personReference is a required property for TpdmSurveySectionResponsePersonTargetAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("surveySectionResponseReference is a required property for TpdmSurveySectionResponsePersonTargetAssociation and cannot be null");
            }
            else
            {
