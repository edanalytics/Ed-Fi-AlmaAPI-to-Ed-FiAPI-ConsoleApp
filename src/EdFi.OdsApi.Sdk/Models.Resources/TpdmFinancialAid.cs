...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmFinancialAid :  IEquatable<TpdmFinancialAid>
    {
        /// <summary>
        ...
        public TpdmFinancialAid(string id = default(string), string aidTypeDescriptor = default(string), DateTime? beginDate = default(DateTime?), EdFiStudentReference studentReference = default(EdFiStudentReference), double? aidAmount = default(double?), string aidConditionDescription = default(string), DateTime? endDate = default(DateTime?), bool? pellGrantRecipient = default(bool?), string etag = default(string))
        {
            ...
            {
                throw new InvalidDataException("aidTypeDescriptor is a required property for TpdmFinancialAid and cannot be null");
            }
            else
            {
            ...
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for TpdmFinancialAid and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("studentReference is a required property for TpdmFinancialAid and cannot be null");
            }
            else
            {
