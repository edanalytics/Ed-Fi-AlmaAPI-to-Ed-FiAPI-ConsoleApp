...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateDisabilityDesignation :  IEquatable<TpdmCandidateDisabilityDesignation>
    {
        /// <summary>
        ...
        public TpdmCandidateDisabilityDesignation(string disabilityDesignationDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("disabilityDesignationDescriptor is a required property for TpdmCandidateDisabilityDesignation and cannot be null");
            }
            else
            {
