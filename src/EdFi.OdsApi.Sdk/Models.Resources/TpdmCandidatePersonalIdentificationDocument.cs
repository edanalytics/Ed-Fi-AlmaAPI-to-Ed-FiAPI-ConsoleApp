...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidatePersonalIdentificationDocument :  IEquatable<TpdmCandidatePersonalIdentificationDocument>
    {
        /// <summary>
        ...
        public TpdmCandidatePersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("identificationDocumentUseDescriptor is a required property for TpdmCandidatePersonalIdentificationDocument and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for TpdmCandidatePersonalIdentificationDocument and cannot be null");
            }
            else
            {
