...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateEducatorPreparationProgramAssociationDegreeSpecialization :  IEquatable<TpdmCandidateEducatorPreparationProgramAssociationDegreeSpecialization>
    {
        /// <summary>
        ...
        public TpdmCandidateEducatorPreparationProgramAssociationDegreeSpecialization(string majorSpecialization = default(string), DateTime? endDate = default(DateTime?), string minorSpecialization = default(string))
        {
            ...
            {
                throw new InvalidDataException("majorSpecialization is a required property for TpdmCandidateEducatorPreparationProgramAssociationDegreeSpecialization and cannot be null");
            }
            else
            {
