...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateEducatorPreparationProgramAssociationCohortYear :  IEquatable<TpdmCandidateEducatorPreparationProgramAssociationCohortYear>
    {
        /// <summary>
        ...
        public TpdmCandidateEducatorPreparationProgramAssociationCohortYear(string cohortYearTypeDescriptor = default(string), string termDescriptor = default(string), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference))
        {
            ...
            {
                throw new InvalidDataException("cohortYearTypeDescriptor is a required property for TpdmCandidateEducatorPreparationProgramAssociationCohortYear and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("schoolYearTypeReference is a required property for TpdmCandidateEducatorPreparationProgramAssociationCohortYear and cannot be null");
            }
            else
            {
