...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    public partial class EdFiCourseTranscript :  IEquatable<EdFiCourseTranscript>
    {
        ...
        /// <param name="externalEducationOrganizationNameOfInstitution">Name of the external institution where the student completed the course; to be used only when the reference ExternalEducationOrganization is not available..</param>
        ...
        /// <summary>
        /// Name of the external institution where the student completed the course; to be used only when the reference ExternalEducationOrganization is not available.
        /// </summary>
        /// <value>Name of the external institution where the student completed the course; to be used only when the reference ExternalEducationOrganization is not available.</value>
        [DataMember(Name="externalEducationOrganizationNameOfInstitution", EmitDefaultValue=false)]
        ...
        public bool Equals(EdFiCourseTranscript input)
        {
            ...
            return 
                ...
                (
                    this.ExternalEducationOrganizationNameOfInstitution == input.ExternalEducationOrganizationNameOfInstitution ||
                    (this.ExternalEducationOrganizationNameOfInstitution != null &&
                    this.ExternalEducationOrganizationNameOfInstitution.Equals(input.ExternalEducationOrganizationNameOfInstitution))
                ) && 
                (
                ...
                (
                    this.PartialCourseTranscriptAwards == input.PartialCourseTranscriptAwards ||
                    this.PartialCourseTranscriptAwards != null &&
                    this.PartialCourseTranscriptAwards.SequenceEqual(input.PartialCourseTranscriptAwards)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExternalEducationOrganizationNameOfInstitution != null)
                    hashCode = hashCode * 59 + this.ExternalEducationOrganizationNameOfInstitution.GetHashCode();
                ...
                if (this.PartialCourseTranscriptAwards != null)
                    hashCode = hashCode * 59 + this.PartialCourseTranscriptAwards.GetHashCode();
