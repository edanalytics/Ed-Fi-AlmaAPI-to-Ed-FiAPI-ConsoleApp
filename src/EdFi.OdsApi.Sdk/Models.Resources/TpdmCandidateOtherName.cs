...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateOtherName :  IEquatable<TpdmCandidateOtherName>
    {
        /// <summary>
        ...
        public TpdmCandidateOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            ...
            {
                throw new InvalidDataException("otherNameTypeDescriptor is a required property for TpdmCandidateOtherName and cannot be null");
            }
            else
            {
            ...
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for TpdmCandidateOtherName and cannot be null");
            }
            else
            {
            ...
            if (lastSurname == null)
            {
                throw new InvalidDataException("lastSurname is a required property for TpdmCandidateOtherName and cannot be null");
            }
            else
            {
