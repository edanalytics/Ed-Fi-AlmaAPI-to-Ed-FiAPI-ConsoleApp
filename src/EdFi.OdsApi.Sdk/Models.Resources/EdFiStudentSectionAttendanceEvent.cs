...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentSectionAttendanceEvent :  IEquatable<EdFiStudentSectionAttendanceEvent>
    {
        /// <summary>
        ...
        public EdFiStudentSectionAttendanceEvent(string id = default(string), string attendanceEventCategoryDescriptor = default(string), DateTime? eventDate = default(DateTime?), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string arrivalTime = default(string), string attendanceEventReason = default(string), List<EdFiStudentSectionAttendanceEventClassPeriod> classPeriods = default(List<EdFiStudentSectionAttendanceEventClassPeriod>), string departureTime = default(string), string educationalEnvironmentDescriptor = default(string), double? eventDuration = default(double?), int? sectionAttendanceDuration = default(int?), string etag = default(string))
        {
