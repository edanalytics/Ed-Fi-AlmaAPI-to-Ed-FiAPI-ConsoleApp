...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateLanguageUse :  IEquatable<TpdmCandidateLanguageUse>
    {
        /// <summary>
        ...
        public TpdmCandidateLanguageUse(string languageUseDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("languageUseDescriptor is a required property for TpdmCandidateLanguageUse and cannot be null");
            }
            else
            {
