...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEvaluationRatingResult :  IEquatable<TpdmEvaluationRatingResult>
    {
        /// <summary>
        ...
        public TpdmEvaluationRatingResult(double? rating = default(double?), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            ...
            if (rating == null)
            {
                throw new InvalidDataException("rating is a required property for TpdmEvaluationRatingResult and cannot be null");
            }
            else
            {
                this.Rating = rating;
            ...
            {
                throw new InvalidDataException("ratingResultTitle is a required property for TpdmEvaluationRatingResult and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("resultDatatypeTypeDescriptor is a required property for TpdmEvaluationRatingResult and cannot be null");
            }
            else
            {
