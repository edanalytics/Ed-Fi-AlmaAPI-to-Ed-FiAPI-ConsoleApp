...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmPerformanceEvaluationRatingResult :  IEquatable<TpdmPerformanceEvaluationRatingResult>
    {
        /// <summary>
        ...
        public TpdmPerformanceEvaluationRatingResult(double? rating = default(double?), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            ...
            if (rating == null)
            {
                throw new InvalidDataException("rating is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
            }
            else
            {
                this.Rating = rating;
            ...
            {
                throw new InvalidDataException("ratingResultTitle is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("resultDatatypeTypeDescriptor is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
            }
            else
            {
