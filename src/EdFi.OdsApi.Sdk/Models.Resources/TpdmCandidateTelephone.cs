...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateTelephone :  IEquatable<TpdmCandidateTelephone>
    {
        /// <summary>
        ...
        public TpdmCandidateTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("telephoneNumberTypeDescriptor is a required property for TpdmCandidateTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("telephoneNumber is a required property for TpdmCandidateTelephone and cannot be null");
            }
            else
            {
