...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateRace :  IEquatable<TpdmCandidateRace>
    {
        /// <summary>
        ...
        public TpdmCandidateRace(string raceDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("raceDescriptor is a required property for TpdmCandidateRace and cannot be null");
            }
            else
            {
