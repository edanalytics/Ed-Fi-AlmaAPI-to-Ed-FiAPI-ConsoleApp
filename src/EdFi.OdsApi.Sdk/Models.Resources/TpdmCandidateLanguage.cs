...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCandidateLanguage :  IEquatable<TpdmCandidateLanguage>
    {
        /// <summary>
        ...
        public TpdmCandidateLanguage(string languageDescriptor = default(string), List<TpdmCandidateLanguageUse> uses = default(List<TpdmCandidateLanguageUse>))
        {
            ...
            {
                throw new InvalidDataException("languageDescriptor is a required property for TpdmCandidateLanguage and cannot be null");
            }
            else
            {
