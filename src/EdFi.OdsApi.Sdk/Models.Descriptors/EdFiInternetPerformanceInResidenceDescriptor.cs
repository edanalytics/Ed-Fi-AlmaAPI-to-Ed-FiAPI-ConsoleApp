...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiInternetPerformanceInResidenceDescriptor :  IEquatable<EdFiInternetPerformanceInResidenceDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInternetPerformanceInResidenceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInternetPerformanceInResidenceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInternetPerformanceInResidenceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="internetPerformanceInResidenceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInternetPerformanceInResidenceDescriptor(string id = default(string), int? internetPerformanceInResidenceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for EdFiInternetPerformanceInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiInternetPerformanceInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiInternetPerformanceInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.InternetPerformanceInResidenceDescriptorId = internetPerformanceInResidenceDescriptorId;
        ...
        [DataMember(Name="internetPerformanceInResidenceDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiInternetPerformanceInResidenceDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InternetPerformanceInResidenceDescriptorId: ").Append(InternetPerformanceInResidenceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInternetPerformanceInResidenceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInternetPerformanceInResidenceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInternetPerformanceInResidenceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInternetPerformanceInResidenceDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InternetPerformanceInResidenceDescriptorId == input.InternetPerformanceInResidenceDescriptorId ||
                    (this.InternetPerformanceInResidenceDescriptorId != null &&
                    this.InternetPerformanceInResidenceDescriptorId.Equals(input.InternetPerformanceInResidenceDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InternetPerformanceInResidenceDescriptorId != null)
                    hashCode = hashCode * 59 + this.InternetPerformanceInResidenceDescriptorId.GetHashCode();
