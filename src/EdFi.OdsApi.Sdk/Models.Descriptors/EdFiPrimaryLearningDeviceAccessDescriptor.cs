...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiPrimaryLearningDeviceAccessDescriptor :  IEquatable<EdFiPrimaryLearningDeviceAccessDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPrimaryLearningDeviceAccessDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPrimaryLearningDeviceAccessDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPrimaryLearningDeviceAccessDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="primaryLearningDeviceAccessDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPrimaryLearningDeviceAccessDescriptor(string id = default(string), int? primaryLearningDeviceAccessDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiPrimaryLearningDeviceAccessDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiPrimaryLearningDeviceAccessDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.PrimaryLearningDeviceAccessDescriptorId = primaryLearningDeviceAccessDescriptorId;
        ...
        [DataMember(Name="primaryLearningDeviceAccessDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiPrimaryLearningDeviceAccessDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PrimaryLearningDeviceAccessDescriptorId: ").Append(PrimaryLearningDeviceAccessDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPrimaryLearningDeviceAccessDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPrimaryLearningDeviceAccessDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPrimaryLearningDeviceAccessDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPrimaryLearningDeviceAccessDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PrimaryLearningDeviceAccessDescriptorId == input.PrimaryLearningDeviceAccessDescriptorId ||
                    (this.PrimaryLearningDeviceAccessDescriptorId != null &&
                    this.PrimaryLearningDeviceAccessDescriptorId.Equals(input.PrimaryLearningDeviceAccessDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrimaryLearningDeviceAccessDescriptorId != null)
                    hashCode = hashCode * 59 + this.PrimaryLearningDeviceAccessDescriptorId.GetHashCode();
