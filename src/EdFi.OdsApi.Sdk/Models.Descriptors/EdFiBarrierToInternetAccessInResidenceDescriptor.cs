...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiBarrierToInternetAccessInResidenceDescriptor :  IEquatable<EdFiBarrierToInternetAccessInResidenceDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiBarrierToInternetAccessInResidenceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiBarrierToInternetAccessInResidenceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiBarrierToInternetAccessInResidenceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="barrierToInternetAccessInResidenceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiBarrierToInternetAccessInResidenceDescriptor(string id = default(string), int? barrierToInternetAccessInResidenceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for EdFiBarrierToInternetAccessInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiBarrierToInternetAccessInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiBarrierToInternetAccessInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.BarrierToInternetAccessInResidenceDescriptorId = barrierToInternetAccessInResidenceDescriptorId;
        ...
        [DataMember(Name="barrierToInternetAccessInResidenceDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiBarrierToInternetAccessInResidenceDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  BarrierToInternetAccessInResidenceDescriptorId: ").Append(BarrierToInternetAccessInResidenceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiBarrierToInternetAccessInResidenceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiBarrierToInternetAccessInResidenceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiBarrierToInternetAccessInResidenceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiBarrierToInternetAccessInResidenceDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BarrierToInternetAccessInResidenceDescriptorId == input.BarrierToInternetAccessInResidenceDescriptorId ||
                    (this.BarrierToInternetAccessInResidenceDescriptorId != null &&
                    this.BarrierToInternetAccessInResidenceDescriptorId.Equals(input.BarrierToInternetAccessInResidenceDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BarrierToInternetAccessInResidenceDescriptorId != null)
                    hashCode = hashCode * 59 + this.BarrierToInternetAccessInResidenceDescriptorId.GetHashCode();
