...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEppProgramPathwayDescriptor :  IEquatable<TpdmEppProgramPathwayDescriptor>
    {
        /// <summary>
        ...
        public TpdmEppProgramPathwayDescriptor(string id = default(string), int? eppProgramPathwayDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmEppProgramPathwayDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmEppProgramPathwayDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmEppProgramPathwayDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.EppProgramPathwayDescriptorId = eppProgramPathwayDescriptorId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEppProgramPathwayDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EppProgramPathwayDescriptorId: ").Append(EppProgramPathwayDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEppProgramPathwayDescriptor);
        }
        ...
        public bool Equals(TpdmEppProgramPathwayDescriptor input)
        {
            ...
            return 
                ...
                (
                    this.EppProgramPathwayDescriptorId == input.EppProgramPathwayDescriptorId ||
                    (this.EppProgramPathwayDescriptorId != null &&
                    this.EppProgramPathwayDescriptorId.Equals(input.EppProgramPathwayDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EppProgramPathwayDescriptorId != null)
                    hashCode = hashCode * 59 + this.EppProgramPathwayDescriptorId.GetHashCode();
