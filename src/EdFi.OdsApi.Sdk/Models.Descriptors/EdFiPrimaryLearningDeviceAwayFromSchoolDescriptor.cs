...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor :  IEquatable<EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="primaryLearningDeviceAwayFromSchoolDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor(string id = default(string), int? primaryLearningDeviceAwayFromSchoolDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.PrimaryLearningDeviceAwayFromSchoolDescriptorId = primaryLearningDeviceAwayFromSchoolDescriptorId;
        ...
        [DataMember(Name="primaryLearningDeviceAwayFromSchoolDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PrimaryLearningDeviceAwayFromSchoolDescriptorId: ").Append(PrimaryLearningDeviceAwayFromSchoolDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PrimaryLearningDeviceAwayFromSchoolDescriptorId == input.PrimaryLearningDeviceAwayFromSchoolDescriptorId ||
                    (this.PrimaryLearningDeviceAwayFromSchoolDescriptorId != null &&
                    this.PrimaryLearningDeviceAwayFromSchoolDescriptorId.Equals(input.PrimaryLearningDeviceAwayFromSchoolDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrimaryLearningDeviceAwayFromSchoolDescriptorId != null)
                    hashCode = hashCode * 59 + this.PrimaryLearningDeviceAwayFromSchoolDescriptorId.GetHashCode();
