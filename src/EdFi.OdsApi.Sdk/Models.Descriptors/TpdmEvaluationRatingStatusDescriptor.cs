...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEvaluationRatingStatusDescriptor :  IEquatable<TpdmEvaluationRatingStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationRatingStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEvaluationRatingStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationRatingStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="evaluationRatingStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEvaluationRatingStatusDescriptor(string id = default(string), int? evaluationRatingStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmEvaluationRatingStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmEvaluationRatingStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmEvaluationRatingStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.EvaluationRatingStatusDescriptorId = evaluationRatingStatusDescriptorId;
        ...
        [DataMember(Name="evaluationRatingStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEvaluationRatingStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EvaluationRatingStatusDescriptorId: ").Append(EvaluationRatingStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEvaluationRatingStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEvaluationRatingStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEvaluationRatingStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEvaluationRatingStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EvaluationRatingStatusDescriptorId == input.EvaluationRatingStatusDescriptorId ||
                    (this.EvaluationRatingStatusDescriptorId != null &&
                    this.EvaluationRatingStatusDescriptorId.Equals(input.EvaluationRatingStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EvaluationRatingStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.EvaluationRatingStatusDescriptorId.GetHashCode();
