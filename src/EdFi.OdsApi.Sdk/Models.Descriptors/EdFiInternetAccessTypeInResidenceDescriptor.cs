...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiInternetAccessTypeInResidenceDescriptor :  IEquatable<EdFiInternetAccessTypeInResidenceDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInternetAccessTypeInResidenceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInternetAccessTypeInResidenceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInternetAccessTypeInResidenceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="internetAccessTypeInResidenceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInternetAccessTypeInResidenceDescriptor(string id = default(string), int? internetAccessTypeInResidenceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiInternetAccessTypeInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiInternetAccessTypeInResidenceDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.InternetAccessTypeInResidenceDescriptorId = internetAccessTypeInResidenceDescriptorId;
        ...
        [DataMember(Name="internetAccessTypeInResidenceDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiInternetAccessTypeInResidenceDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InternetAccessTypeInResidenceDescriptorId: ").Append(InternetAccessTypeInResidenceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInternetAccessTypeInResidenceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInternetAccessTypeInResidenceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInternetAccessTypeInResidenceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInternetAccessTypeInResidenceDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InternetAccessTypeInResidenceDescriptorId == input.InternetAccessTypeInResidenceDescriptorId ||
                    (this.InternetAccessTypeInResidenceDescriptorId != null &&
                    this.InternetAccessTypeInResidenceDescriptorId.Equals(input.InternetAccessTypeInResidenceDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InternetAccessTypeInResidenceDescriptorId != null)
                    hashCode = hashCode * 59 + this.InternetAccessTypeInResidenceDescriptorId.GetHashCode();
