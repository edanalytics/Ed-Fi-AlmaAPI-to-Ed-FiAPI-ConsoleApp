...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiPrimaryLearningDeviceProviderDescriptor :  IEquatable<EdFiPrimaryLearningDeviceProviderDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPrimaryLearningDeviceProviderDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPrimaryLearningDeviceProviderDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPrimaryLearningDeviceProviderDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="primaryLearningDeviceProviderDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPrimaryLearningDeviceProviderDescriptor(string id = default(string), int? primaryLearningDeviceProviderDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for EdFiPrimaryLearningDeviceProviderDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for EdFiPrimaryLearningDeviceProviderDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for EdFiPrimaryLearningDeviceProviderDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.PrimaryLearningDeviceProviderDescriptorId = primaryLearningDeviceProviderDescriptorId;
        ...
        [DataMember(Name="primaryLearningDeviceProviderDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiPrimaryLearningDeviceProviderDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PrimaryLearningDeviceProviderDescriptorId: ").Append(PrimaryLearningDeviceProviderDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPrimaryLearningDeviceProviderDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPrimaryLearningDeviceProviderDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPrimaryLearningDeviceProviderDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPrimaryLearningDeviceProviderDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PrimaryLearningDeviceProviderDescriptorId == input.PrimaryLearningDeviceProviderDescriptorId ||
                    (this.PrimaryLearningDeviceProviderDescriptorId != null &&
                    this.PrimaryLearningDeviceProviderDescriptorId.Equals(input.PrimaryLearningDeviceProviderDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrimaryLearningDeviceProviderDescriptorId != null)
                    hashCode = hashCode * 59 + this.PrimaryLearningDeviceProviderDescriptorId.GetHashCode();
