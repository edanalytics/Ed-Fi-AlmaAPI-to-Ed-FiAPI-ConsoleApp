...
namespace EdFi.AlmaToEdFi.Cmd
{
    public class App
    {
        ...
        public App(IOptions<AppSettings> settings, ILogger<App> logger, IAlmaApi almaApi, IEnumerable<IProcessor> processors)
        {
        ...
        public async Task Run(string[] args)
        {
            ...
            // TODO: Get all schools in the district.
            ...
            foreach (var school in almaSchools.response.schools)
            {
                ...
                foreach (var processor in _processors.OrderBy(x => x.ExecutionOrder))
                {
                    ...
                    processor.ExecuteETL(school.id, Convert.ToInt32(school.stateId));
                    stopWatch.Stop();
